...
uint8_t Get_LEDx_State(uint8_t _Num)
{
	if (_Num == 1)
	{
		if(HAL_GPIO_ReadPin(LED1_GPIO,LED1_GPIO_PIN) == GPIO_PIN_SET)
		{
			return 1;
		}
		return 0;
	...
	{
		if(HAL_GPIO_ReadPin(LED2_GPIO,LED2_GPIO_PIN) == GPIO_PIN_SET)
		{
			return 1;
		}
		return 0;
	...
	{
		if(HAL_GPIO_ReadPin(LED3_GPIO,LED3_GPIO_PIN) == GPIO_PIN_SET)
		{
			return 1;
		}
		return 0;
